...
int main(void)
{
  ...
  ssd1306_Clear();
  _ssd1306_WriteInTheMiddle("ROBOILO", 0, BIG);
  _ssd1306_WriteInTheMiddle("evangelion++!", 22, SMALL);
...
void _ssd1306_WriteInTheMiddle(char *text, uint8_t y, uint8_t font)
{
	...
	else if(font == SMALL) //max 21chars
	{
		x = (int)(128 - textSize*6)/2;
		if(x < 0)
		{
			text="ERR LENGHT";
			x = 0;
